              ...
              <div>
                <div>
                  <img
                    ...
                    src="/color1_icon_transparent_background.png"
                    alt=""
                  />
                  <img
                    className="h-32 w-auto sm:h-60"
                    src="/color1_textlogo_transparent_background.png"
                    alt=""
                  />
                </div>
                <div className="mt-1">
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
                <div>
                  <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
                    Integration is more than just moving data around.
                  </h2>
